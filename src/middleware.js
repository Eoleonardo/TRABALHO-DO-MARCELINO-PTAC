...
export const middleware = (request) => { // Define uma função middleware que recebe um objeto "request" como argumento.
    ...
    const isTokenValidated = validateToken(token); // Chama a função validateToken para verificar se o token é válido.
